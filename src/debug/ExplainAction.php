...
/**
 * ExplainAction provides EXPLAIN information for CouchDB queries
 *
...
{
    /**
     * @var CouchDBPanel related debug toolbar panel
     */
    public $panel;
    ...
    {
        /* @var $connection \yii\couchdb\Connection */
    ...
    private function prepareQueryFiler($query)
    {
        ...
        foreach ($query as $key => $value) {
            ...
            } elseif (is_string($value) && preg_match('#^(CouchDB\\\\[A-Za-z]+)\\((.*)\\)$#s', $value, $matches)) {
                $class = $matches[1];
