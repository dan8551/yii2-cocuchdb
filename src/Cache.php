...
/**
 * Cache implements a cache application component by storing cached data in a CouchDB.
 *
 * By default, Cache stores session data in a CouchDB collection named 'cache' inside the default database.
...
class Cache extends \yii\caching\Cache
{
    ...
    public $db = 'couchdb';
    /**
     * @var string|array the name of the CouchDB collection that stores the cache data.
