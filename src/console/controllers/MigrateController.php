...
namespace yii\couchdb\console\controllers;
...
/**
 * Manages application CouchDB migrations.
 *
 * This is an analog of [[\yii\console\controllers\MigrateController]] for CouchDB.
 *
 * This command provides support for tracking the migration history, upgrading
 * or downloading with migrations, and creating new migration skeletons.
 *
 * The migration history is stored in a CouchDB collection named
 ...
 *     // ...
 *     'controllerMap' => [
 *         'couchdb-migrate' => 'yii\couchdb\console\controllers\MigrateController'
 *     ],
 * ];
 * ```
 *
 ...
 * yii couchdb-migrate/create create_user_collection
 *
 * # applies ALL new migrations
 * yii couchdb-migrate
 *
 * # reverts the last applied migration
 * yii couchdb-migrate/down
 * ```
 *
 ...
 *     'controllerMap' => [
 *         'couchdb-migrate' => [
 *             'class' => 'yii\couchdb\console\controllers\MigrateController',
 *             'migrationNamespaces' => [
 *                 'app\migrations',
...
class MigrateController extends BaseMigrateController
{
     ...
     * {@inheritdoc}
     */
    public $templateFile = '@yii/couchdb/views/migration.php';
    /**
        ...
        if (parent::beforeAction($action)) {
            if ($action->id !== 'create') {
                ...
                if (!$this->db instanceof Connection) {
                    throw new Exception("The 'db' option must refer to the application component ID of a CouchDB connection.");
                }
            }
            return true;
        }
     ...
     * @return \yii\couchdb\Migration the migration instance
     */
