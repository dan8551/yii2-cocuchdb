...
/**
 * Migration is the base class for representing a CouchDB migration.
 *
 * Each child class of Migration represents an individual CouchDB migration which
 ...
 * logic.
 *
 * Migration provides a set of convenient methods for manipulating CouchDB data and schema.
...
abstract class Migration extends Component implements MigrationInterface
{
     ...
     * Note: for "multiple" mode CouchDB requires explicit strategy "$set" or "$inc"
     ...
     * @param array $options list of options in format: optionName => optionValue.
     * @todo return???
     * @return ??? updated/new record id instance.
     */
