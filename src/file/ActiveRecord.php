...
/**
 * ActiveRecord is the base class for classes representing CouchDB GridFS files in terms of objects.
 *
 ...
 */
abstract class ActiveRecord extends \yii\couchdb\ActiveRecord
{
    /**
     * {@inheritdoc}
    ...
    /**
     * Return the CouchDB GridFS collection instance for this AR class.
     ...
     * @todo return ???
     * @return ???|null refreshed file value.
     */
    public function refreshFile()
    {
        $couchdbFile = $this->getCollection()->get($this->getPrimaryKey());
        $this->setAttribute('file', $couchdbFile);
     ...
     * which deal with reading files. The contents of the file are pulled out of CouchDB on the fly,
