...
/**
 * ActiveQuery represents a couchdb query associated with an file Active Record class.
 *
...
class ActiveQuery extends Query implements ActiveQueryInterface
{
     ...
     * @param \yii\couchdb\Connection $db the CouchDB connection used to execute the query.
