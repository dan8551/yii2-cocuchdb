...
/**
 * ActiveQuery represents a CouchDB query associated with an Active Record class.
 *
...
class ActiveQuery extends Query implements ActiveQueryInterface
{
     ...
     * If null, the CouchDB connection returned by [[modelClass]] will be used.
     ...
     * This method is internally used to convert the data fetched from CouchDB
     * into the format as required by this query.
     * @param array $rows the raw query result from CouchDB
