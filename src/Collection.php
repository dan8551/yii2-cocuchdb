...
/**
 * Collection represents the CouchDB collection information.
 *
 * A collection object is usually created by calling [[Database::getCollection()]] or [[Connection::getCollection()]].
 *
 * Collection provides the basic interface for the CouchDB queries, mostly: insert, update, delete operations.
 * For example:
 *
 * ```php
 * $collection = Yii::$app->couchdb->getCollection('customer');
...
{
    /**
     * @var Database CouchDB database instance.
     */
    public $database;
    /**
     ...
     * @todo return what???
     * @return ??? cursor for the search results
     * @see Query
     */
     ...
     * Note: for "multi" mode CouchDB requires explicit strategy "$set" or "$inc"
     ...
     * @param array $options list of options in format: optionName => optionValue.
     * @todo return what???
     * @return ???D updated/new record id instance.
     * @throws Exception on failure.
     */
    ...
    /**
     * Performs aggregation using CouchDB "group" command.
     * @todo does this exist?
     * @param mixed $keys fields to group by. If an array or non-code object is passed,
     * it will be the key used to group results. If instance of [[JSON]] passed,
     * it will be treated as a function that returns the key to group by.
     * @param array $initial Initial value of the aggregation counter object.
     * @param JSON|string $reduce function that takes two arguments (the current
    ...
    /**
     * Performs aggregation using CouchDB "map-reduce" mechanism.
     * Note: this function will not return the aggregation result, instead it will
     * write it inside the another CouchDB collection specified by "out" parameter.
     * For example:
     *
     * ```php
     * $customerCollection = Yii::$app->couchdb->getCollection('customer');
