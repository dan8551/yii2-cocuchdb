...
/**
 * CouchDBManager represents an authorization manager that stores authorization information in CouchDB.
 *
 ...
 */
class CouchDBManager extends BaseManager
{
    /**
     * @var Connection|array|string the CouchDB connection object or the application component ID of the CouchDB connection.
     * After the CouchDBManager object is created, if you want to change this property, you should only assign it
     ...
     * This method overrides the parent implementation by establishing the CouchDB connection.
     */
