...
/**
 * ActiveRecord is the base class for classes representing CouchDB documents in terms of objects.
 *
...
{
    /**
     * Returns the CouchDB connection used by this AR class.
     * By default, the "couchdb" application component is used as the CouchDB connection.
     * You may override this method if you want to use a different database connection.
     * @return Connection the database connection used by this AR class.
     */
    public static function getDb()
    {
        return Yii::$app->get('couchdb');
    }
    ...
    /**
     * Declares the name of the CouchDB collection associated with this AR class.
     *
    ...
    /**
     * Return the CouchDB collection instance for this AR class.
     ...
     *
     * @return string[] the primary keys of the associated CouchDB collection.
     */
    ...
    public function attributes()
    {
        throw new InvalidConfigException('The attributes() method of couchdb ActiveRecord has to be implemented by child classes.');
    }

    /**
     * Inserts a row into the associated CouchDB collection using the attribute values of this record.
     *
     ...
     * @return bool whether the two active records refer to the same row in the same CouchDB collection.
     */
    ...
    /**
     * Converts data to array recursively, converting CouchDB JSON objects to readable values.
