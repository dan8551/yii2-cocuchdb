...
/**
 * StreamWrapper provides stream wrapper for CouchDB GridFS, allowing file operations via
 * regular PHP stream resources.
 *
 * Before feature can be used this wrapper should be registered via [[register()]] method.
 * It is usually performed via [[yii\couchdb\Connection::registerFileStreamWrapper()]].
 *
