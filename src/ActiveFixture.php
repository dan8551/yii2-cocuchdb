...
/**
 * ActiveFixture represents a fixture backed up by a [[modelClass|CouchDB ActiveRecord class]] or a [[collectionName|CouchDB collection]].
 *
...
class ActiveFixture extends BaseActiveFixture
{
     ...
     * The default implementation will first reset the CouchDB collection and then populate it with the data
     * returned by [[getData()]].
     */
