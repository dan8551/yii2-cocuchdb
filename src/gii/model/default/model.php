...
/* @var $generator yii\couchdb\gii\model\Generator */
 ...
 * @property <?= $attribute == '_id' ? 'string' : 'mixed' ?> <?= "\${$attribute}\n" ?>
<?php endforeach; ?>
 */
...
<?php if ($generator->db !== 'couchdb'): ?>

    /**
     * @return \yii\couchdb\Connection the CouchDB connection used by this AR class.
     */
