...
/**
 * Query represents CouchDB "find" operation.
 *
...
class Query extends Component implements QueryInterface
{
     ...
     * @param Connection $db CouchDB connection.
     ...
     * internally translated to a CouchDB operator.
    ...
    /**
     * Builds the CouchDB cursor for this query.
     * @param Connection $db the CouchDB connection used to execute the query.
     * @todo return ???
    ...
    /**
     * Fetches rows from the given CouchDB cursor.
     * @todo cursor ???
     * @param ??? $cursor cursor instance to fetch data from.
     ...
     * @param Connection $db the CouchDB connection. If not set, the "couchdb" application component will be used.
     ...
     * @param Connection $db the CouchDB connection used to execute the query.
     * If this parameter is not given, the `couchdb` application component will be used.
     ...
     * @param Connection $db the CouchDB connection used to generate the query.
     * If this parameter is not given, the `couchdb` application component will be used.
