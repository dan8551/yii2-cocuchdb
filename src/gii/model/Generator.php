...
namespace yii\couchdb\gii\model;

use Yii;
use yii\helpers\ArrayHelper;
use yii\couchdb\ActiveRecord;
use yii\couchdb\Connection;
use yii\gii\CodeFile;
use yii\helpers\Inflector;

/**
 * This generator will generate ActiveRecord class for the specified CouchDB collection.
 *
...
class Generator extends \yii\gii\Generator
{
    ...
    public $modelClass;
    public $baseClass = 'yii\couchdb\ActiveRecord';
    ...
    {
        return 'CouchDB Model Generator';
    }
    ...
    {
        return 'This generator generates an ActiveRecord class for the specified CouchDB collection.';
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'db' => 'This is the ID of the CouchDB application component.',
            'collectionName' => 'This is the name of the CouchDB collection that the new ActiveRecord class is associated with, e.g. <code>post</code>.',
            'databaseName' => 'This is the name of the CouchDB database, which contains the collection that the new ActiveRecord class is associated with.
                You may leave this field blank, if your application uses single CouchDB database.',
    ...
    public function validateDb()
    {
        if (!Yii::$app->has($this->db)) {
            ...
            $this->addError('db', 'The "' . $this->db . '" application component must be a CouchDB connection instance.');
        }
    }
