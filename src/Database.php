...
/**
 * Database represents the CouchDB database information.
 *
 * @property file\Collection $fileCollection CouchDB GridFS collection. This property is read-only.
 *
...
class Database extends BaseObject
{
    ...
    /**
     * Returns CouchDB GridFS collection with given prefix.
     * @param string $prefix collection prefix.
     * @param bool $refresh whether to reload the collection instance even if it is found in the cache.
     * @return file\Collection CouchDB GridFS collection.
     */
    ...
    {
        return Yii::createObject([
            'class' => 'yii\couchdb\file\Collection',
            'database' => $this,
            'prefix' => $prefix,
        ]);
    }
    ...
    /**
     * Creates CouchDB command associated with this database.
     ...
     * Note: CouchDB creates new collections automatically on the first demand,
