...
use yii\couchdb\Query;

/**
 * CouchDBMessageSource extends [[MessageSource]] and represents a message source that stores translated
 * messages in CouchDB collection.
 *
 ...
 * @since 2.0.5
 */
class CouchDBMessageSource extends MessageSource
{
    /**
     * @var Connection|array|string the CouchDB connection object or the application component ID of the CouchDB connection.
     *
     * After the CouchDBMessageSource object is created, if you want to change this property, you should only assign
     * it with a CouchDB connection object.
     *
    ...
    public $cache = 'cache';
    /**
     * @var string|array the name of the CouchDB collection, which stores translated messages.
    ...
    /**
     * Loads the messages from CouchDB.
     * You may override this method to customize the message storage in the CouchDB.
     * @param string $category the message category.
     * @param string $language the target language.
