...
/**
 * Collection represents the CouchDB GridFS collection information.
 *
 * A file collection object is usually created by calling [[Database::getFileCollection()]] or [[Connection::getFileCollection()]].
 *
 * File collection inherits all interface from regular [[\yii\couchdb\Collection]], adding methods to store files.
 *
 * @property \yii\couchdb\Collection $chunkCollection CouchDB collection instance. This property is read-only.
 * @property \yii\couchdb\Collection $fileCollection CouchDB collection instance. This property is read-only.
 * @property string $prefix Prefix of this file collection.
 *
 * @author Dan Orton <dan.orton84@gmail.com>
 */
class Collection extends \yii\couchdb\Collection
{
    /**
     * @var \yii\couchdb\Database CouchDB database instance.
     */
    public $database;
    ...
    private $_prefix;
    /**
     * @var \yii\couchdb\Collection file chunks CouchDB collection.
     */
    private $_chunkCollection;
    /**
     * @var \yii\couchdb\Collection files CouchDB collection.
     */
    ...
    /**
     * Returns the CouchDB collection for the file chunks.
     * @param bool $refresh whether to reload the collection instance even if it is found in the cache.
     * @return \yii\couchdb\Collection CouchDB collection instance.
     */
    ...
    /**
     * Returns the CouchDB collection for the files.
     * @param bool $refresh whether to reload the collection instance even if it is found in the cache.
     * @return \yii\couchdb\Collection CouchDB collection instance.
     * @since 2.1
     */
     ...
     * @return mixed the "_id" of the saved file document. This will be a generated [[\CouchDBId]]
